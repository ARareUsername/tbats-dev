          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                {(Object.entries(PROJECTS) as [ProjectKey, typeof PROJECTS[ProjectKey]][]).map(([key, project]) => {
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', marginTop: '0.25rem', marginBottom: 0 }}>
                      Initial State: <strong style={{ color: 'var(--text-primary)' }}>{currentPreset.label} Preset</strong>
                    </p>
                  </div>
                  ...
                  <div style={{
                    ...
                    <div>
                      <strong style={{ color: 'var(--text-primary)' }}>Colors:</strong> {currentPreset.colorText}
                    </div>
                    <div>
                      <strong style={{ color: 'var(--text-primary)' }}>Typography:</strong> {currentPreset.typography}
                    </div>
                    <div>
                      <strong style={{ color: 'var(--text-primary)' }}>Grid Layout:</strong> {currentPreset.layout}
                    </div>
                  </div>
