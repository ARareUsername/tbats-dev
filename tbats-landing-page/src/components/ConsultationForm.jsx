            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', background: 'rgba(255, 255, 255, 0.01)', border: '1px solid var(--border-color)', padding: '2rem', borderRadius: '4px', textAlign: 'left' }}>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  ...
                  >
                    <option value="₱29,000 - ₱50,000 (Starter)" style={{ color: 'var(--text-primary)', background: 'var(--bg-dark-end)' }}>₱29,000 - ₱50,000 (Starter)</option>
                    <option value="₱50,000 - ₱100,000 (Growth)" style={{ color: 'var(--text-primary)', background: 'var(--bg-dark-end)' }}>₱50,000 - ₱100,000 (Growth)</option>
                    <option value="₱100,000+ (Scale)" style={{ color: 'var(--text-primary)', background: 'var(--bg-dark-end)' }}>₱100,000+ (Scale)</option>
                  </select>
                </div>
