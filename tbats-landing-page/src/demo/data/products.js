export const products = [
  {
    ...
    price: 32500,
    category: 'furniture',
    description: 'A classic Scandinavian lounge chair constructed from premium solid oak wood with hand-woven paper cord seat.',
  ...
  },
  {
    ...
    price: 11000,
    category: 'lighting',
    description: 'A stoneware base thrown by hand, paired with a natural linen lampshade for gentle ambient light dispersion.',
  ...
  },
  {
    ...
    description: 'Traditional Japanese-style cast iron kettle designed to distribute heat evenly and keep tea warm.',
  ...
  },
  {
    ...
    price: 3000,
    category: 'kitchenware',
    description: 'Thin-profile borosilicate glass carafe for serving water or wine, complete with a natural oak ball stopper.',
  ...
  },
  {
    ...
    description: 'A minimal full-grain leather tote bag with interior pockets, hand-stitched details, and solid brass rivets.',
  ...
  },
  {
    ...
    price: 1750,
    category: 'accessories',
    description: 'A secure geometric key clasp machined from solid raw brass, which will develop a rich patina over time.',
  ...
  },
  {
    ...
    price: 2750,
    category: 'accessories',
    description: 'Dense merino wool felt sleeve with premium leather closures, providing shock absorption and scratch resistance.',
  ...
  },
  {
    ...
    price: 1600,
    category: 'stationery',
    description: 'Hardcover sketch diary with lay-flat binding and 160 pages of ink-proof, acid-free heavy cotton paper.',
  ...
  },
  {
    ...
    price: 5750,
    category: 'stationery',
    description: 'Three-piece modular wooden tray set (pen tray, phone stand, paperclip tray) with slip-proof bottom pads.',
