...
export default function CheckoutSuccess({ orderNumber, emailAddress, onContinue }) {
  return (
    <div className="p-checkout-success-step">
      ...
      <p className="p-success-msg">Thank you for your purchase. Your order has been placed successfully.</p>
      ...
      <p className="p-success-note">This is a mock transaction for demonstration purposes. No real payment has been processed.</p>
