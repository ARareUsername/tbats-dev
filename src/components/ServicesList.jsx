...
export default function ServicesList() {
  return (
    <section id="services" style={{ background: 'linear-gradient(to bottom, #000000, #030303)' }}>
      <div className="container">
        <div style={{ marginBottom: '4rem', textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: '3rem', marginTop: '0.5rem', marginBottom: '1rem' }} className="text-gradient">Our Capabilities</h2>
        ...
        <div className="grid-3">
          {pillars.map((pillar) => (
            ...
            >
              ...
              <div>
                <h4 style={{ fontSize: '0.8rem', textTransform: 'uppercase', color: 'rgba(255, 255, 255, 0.4)', letterSpacing: '0.1em', marginBottom: '1rem' }}>
                  Core Competencies
                </h4>
