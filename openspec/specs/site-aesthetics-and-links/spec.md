...
The landing page buttons and nav links SHALL correctly scroll to their respective sections.

#### Scenario: Clicking CTA buttons
- **WHEN** the user clicks "Start a Project" or "How We Work"
- **THEN** the browser smoothly scrolls to the Consultation Form (#contact) or the Process Timeline (#process).
