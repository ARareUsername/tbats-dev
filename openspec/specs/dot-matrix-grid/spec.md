# Capability: Dot Matrix Grid

## Purpose
Specifies the spotlight dot-matrix background animation behavior and its conditional visibility based on active page routing.
